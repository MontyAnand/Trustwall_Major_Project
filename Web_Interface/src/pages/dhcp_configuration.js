                    ...
                    <div className="dhcp_internal_container">
                        <form className="dhcp_general_container">
                            ...
                            <div className="dhcp_checkbox">
                                <label name="Interface_Name">Enable</label>
                                <div>
                            ...
                            <div className="dhcp_checkbox">
                                ...
                                <div>
                                    <input type="checkbox" for=""></input>
                                    <p>Do not record a unique identifier(UID) in client <br></br>
                                    lease data if present in client DHCP request</p>
                                </div>
                            </div>
                        </form>
                    </div>
                ])
            }>General DHCP Options</h2>
            {content1[0] ? (
                <>{content1[1]}</>
            ) : (
                <></>
                    ...
                    <div className="dhcp_internal_container">
                        <div className="dhcp_primary_container">
                            ...
                            <div className="dhcp_text">
                                ...
                                <input type="text" placeholder="192.168.1.1 - 192.168.1.254"></input>
                            </div>
                            <div className="dhcp_text">
                            ...
                            <div className="dhcp_add_btn">
                                ...
                                }}><span>&#43;</span> Add Address Pool</button>
                            </div>
                        </div>
                    </div>
                ])
            }>Primary Address Pool</h2>
            {content2[0] ? (
                <>{content2[1]}</>
            ) : (
                <></>
                ...
                setContent4(prevContent =>[
                    ...
                    <div className="dhcp_internal_container">
                        <div className="dhcp_omapi_container">
                            ...
                            <div className="dhcp_checkbox">
                            <label name="">Generate New Key</label>
                            <input type="checkbox" for=""></input>
                            </div>
                    ...
                    <div className="dhcp_internal_container">
                        <div className="dhcp_other_container">
                            ...
                            <div className="dhcp_btn">
                                ...
                                <button><span>&#9965;</span> Display Advanced</button>
                            </div>
                            <div className="dhcp_btn">
