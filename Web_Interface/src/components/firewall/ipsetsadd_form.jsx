...
export const IPsetaddform = ({ visibleDialog }) => {
    ...
    const [ipsetShort, setIPSetShort] = useState('');
    ...
    const editIPSetOnClick = async () => {
        try {
            await dispatch(createIPSet(ipsetName, ipsetType, ipsetFamily, { ipsetTimeout, ipsetHasSize, ipsetMaxelem }));
