...
export const Porteditform = ({ visibleDialog, edit, get, selectedItem, selectedPort }) => {

    const dispatch = useDispatch();
    const { isLoading, error } = useSelector(state => state.zone);

    const [port, setPort] = useState(selectedPort.port);
    const [protocol, setProtocol] = useState(selectedPort.protocol);
